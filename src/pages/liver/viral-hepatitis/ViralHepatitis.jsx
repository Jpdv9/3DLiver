    ...
    const lessons = [
        ...
        },
        {
            ...
            content: (
                <>
                    <p>
                        Los síntomas de la hepatitis viral pueden variar según el tipo y la gravedad de la infección. Algunos síntomas comunes incluyen:
                            <ul>
                                <li>Fatiga</li>
                        ...
                        Sin embargo, algunas personas pueden no presentar síntomas, especialmente en las etapas iniciales de la infección.
                    </p>
                </>
            )
        },
        {
            ...
            content: (
                <>
                    <p>
                        El tratamiento de la hepatitis viral depende del tipo de virus y la gravedad de la infección.
                        En algunos casos, el tratamiento puede no ser necesario, ya que el cuerpo puede eliminar el virus por sí mismo.
                        Sin embargo, en casos más graves, se pueden utilizar medicamentos antivirales para ayudar a controlar la infección y prevenir complicaciones.
                        <br /> Para la hepatitis B y C, existen tratamientos antivirales específicos que pueden ayudar a reducir la carga viral y prevenir el daño hepático.
                        <br /> La hepatitis A y E generalmente no requieren tratamiento específico, pero es importante mantener una buena hidratación y reposo.
                        <br /> La prevención es clave, y las vacunas están disponibles para la hepatitis A y B.
                        <br /> La hepatitis C no tiene vacuna, pero se pueden tomar medidas para reducir el riesgo de infección, como evitar compartir agujas y practicar sexo seguro.
                        <br /> La hepatitis D solo ocurre en personas infectadas con hepatitis B, por lo que la prevención de la hepatitis B también previene la hepatitis D.
                        <br /> La hepatitis E es más común en áreas con saneamiento deficiente y se puede prevenir mejorando las condiciones de higiene y acceso a agua potable.
                    </p>
                </>
            )
        }
        ...
        <div className='viral-hepatitis-container'>
            ...
            <div className='hepatitis-model-wrapper'>
                <div className='hepatitis-instructions-help-container'>
                    ...
                    {showInstructionsPopover && (
                        <div className='hepatitis-instructions-popover' ref={popoverRef}>
                            <p>
